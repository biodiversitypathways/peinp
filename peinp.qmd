...
windows <- tribble(
  ...
  "Spring migration",        110,    145,    "#74C2E1",
  "Breeding",                145,    200,    "#F4A261",
  "Post-breeding / roost",   200,    240,    "#E76F51",
  "Fall migration",          240,    270,    "#74F5E1"
) |>
...
ggplot() +
  ...
  geom_rug(
  data = bans_rec_all,
  aes(x = doy, colour = factor(bans_present)),
  alpha = 0.4,
  sides = "b"
) +
scale_colour_manual(
  values = c("0" = "#F4A3A3", "1" = "green"),
  name = NULL
) +
  # GAM smooth + CI

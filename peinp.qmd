...
total_bans <- all_recs |>
  ...
  mutate(
    ...
    pct_analyzed    = round((hrs_analyzed / hrs_collected) * 100, 0),
...
Finally the predicted heatmap of detection at Bowley Pond (@fig-bowley-heat) and for all Bank swallow monitoring locations (@fig-all-heat).

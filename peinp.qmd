...
- Set your WildTrax username and password either through `Sys.setenv` or using the `keyring` package; authorize into WildTrax
- Load the `.RData` file in the first chunk

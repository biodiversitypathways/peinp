...
pei_locs <- pei_locs |> mutate(coast_distance = as.numeric(st_distance(geometry, coast_nearest$geometry, by_element = TRUE)), .after = year)
...
task_info <- map_dfr(pei_projects, ~wt_get_sync("project_aru_tasks", .x))

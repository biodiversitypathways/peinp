...
bans_projects <- wt_get_projects('ARU') |> filter(grepl('Bank Swallow Monitoring 2025|Bank Swallow Monitoring 2023|Bank Swallow Monitoring 2022|Prince Edward Island National Park Forest Songbird Monitoring 2021', project)) |> pull(project_id)
...
#| tbl-cap: "Summary of Bank Swallow ARU monitoring sites within PEINP, 2021–2025. Hours collected reflect total recording effort; hours analyzed reflect processed tasks only. Proportion analyzed is calculated per site per year. BANS detections are the number of unique detections of BANS within a recording under a count-removal framework at the 30-minute recording level."
...
ggplot(bowley_hour, aes(x = hour, fill = period)) +

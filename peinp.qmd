...
occu_one_19@siteCovs$Anthro <- scale(occu_one_19@siteCovs$Anthro)
occu_one_19@siteCovs$Open <- scale(occu_one_19@siteCovs$Open)
occu_one_19@siteCovs$Conifer <- scale(occu_one_19@siteCovs$Conifer)
occu_one_19@siteCovs$Deciduous <- scale(occu_one_19@siteCovs$Deciduous)

print('Breaking here2????')

occu_one_20@siteCovs$coast_dist <- scale(occu_one_20@siteCovs$coast_dist)
occu_one_20@siteCovs$Anthro <- scale(occu_one_20@siteCovs$Anthro)
occu_one_20@siteCovs$Open <- scale(occu_one_20@siteCovs$Open)
occu_one_20@siteCovs$Conifer <- scale(occu_one_20@siteCovs$Conifer)
occu_one_20@siteCovs$Deciduous <- scale(occu_one_20@siteCovs$Deciduous)

print('Breaking here2????????')

occu_one_21@siteCovs$coast_dist <- scale(occu_one_21@siteCovs$coast_dist)
occu_one_21@siteCovs$Anthro <- scale(occu_one_21@siteCovs$Anthro)
occu_one_21@siteCovs$Open <- scale(occu_one_21@siteCovs$Open)
occu_one_21@siteCovs$Conifer <- scale(occu_one_21@siteCovs$Conifer)
occu_one_21@siteCovs$Deciduous <- scale(occu_one_21@siteCovs$Deciduous)

print('Breaking here2?????????????')

occu_one_22@siteCovs$coast_dist <- scale(occu_one_22@siteCovs$coast_dist)
occu_one_22@siteCovs$Anthro <- scale(occu_one_22@siteCovs$Anthro)
occu_one_22@siteCovs$Open <- scale(occu_one_22@siteCovs$Open)
occu_one_22@siteCovs$Conifer <- scale(occu_one_22@siteCovs$Conifer)
occu_one_22@siteCovs$Deciduous <- scale(occu_one_22@siteCovs$Deciduous)

print('Breaking here2????????????????')

occu_one_23@siteCovs$coast_dist <- scale(occu_one_23@siteCovs$coast_dist)
occu_one_23@siteCovs$Anthro <- scale(occu_one_23@siteCovs$Anthro)
occu_one_23@siteCovs$Open <- scale(occu_one_23@siteCovs$Open)
occu_one_23@siteCovs$Conifer <- scale(occu_one_23@siteCovs$Conifer)
occu_one_23@siteCovs$Deciduous <- scale(occu_one_23@siteCovs$Deciduous)
...
occu_model_19 <- occu(~ doy + hr ~ coast_dist + Anthro + Open + Deciduous + Conifer, occu_one_19)
occu_model_20 <- occu(~ doy + hr ~ coast_dist + Anthro + Open + Deciduous + Conifer, occu_one_20)
occu_model_21 <- occu(~ doy + hr ~ coast_dist + Anthro + Open + Deciduous + Conifer, occu_one_21)
occu_model_22 <- occu(~ doy + hr ~ coast_dist + Anthro + Open + Deciduous + Conifer, occu_one_22)
occu_model_23 <- occu(~ doy + hr ~ coast_dist + Anthro + Open + Deciduous + Conifer, occu_one_23)
...
#occ_dredge <- dredge(occu_model_19)

# model_comparison <- as.data.frame(occ_dredge) %>% 
#   select(starts_with("psi(p"), df, AICc, delta, weight)
# # shorten names for printing
# names(model_comparison) <- names(model_comparison) %>% 
#   str_extract("(?<=psi\\(pland_[0-9]{2}_)[a-z_]+") %>% 
#   coalesce(names(model_comparison))
# 
# mutate_all(model_comparison, ~ round(., 3)) %>% 
#   head(18) %>% 
#   knitr::kable()
# 
# 
...
# occ_model_sel <- model.sel(occ_dredge)
...
ggarrange(revi_occ, amre_occ, btnw_occ, nopa_occ, mawa_occ)

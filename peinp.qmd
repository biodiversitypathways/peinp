...
#| include: true
#| code-fold: true
#| fig-cap: Heatmap of predicted probability of detection of Bank swallow at Bowley Pond in 2025 with 3 ARU detectors placed around the pond. Orange shaded areas indicate dawn period, while blue indicates dusk period.
...
#| include: true
#| code-fold: true
#| fig-cap: Heatmap of predicted probability of detection of Bank swallow at all monitoring sites. Orange shaded areas indicate dawn period, while blue indicates dusk period.
#| label: fig-all-heat
...
#| include: true
#| code-fold: true
#| fig-cap: Probability of detection of Bank swallow overlaid on breeding phase windows. The curve indicates the GAM smoothed model with 95% CI. Rug plot data indicates positive sampling events.
#| label: fig-breeding
